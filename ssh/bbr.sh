...
#BURIQ () {
 #   curl -sS https://raw.githubusercontent.com/johayi/allow/main/izin > /root/tmp
...
#Name=$(curl -sS https://raw.githubusercontent.com/johayi/allow/main/izin | grep $MYIP | awk '{print $2}')
